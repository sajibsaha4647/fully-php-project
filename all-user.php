	...
	<div class="col-md-12">
		<div class="panel panel-primary">
		  ...
		  <div class="panel-body">
			<form method="post" action="search-user.php" class="form-inline my-2 my-lg-0" style="margin-top:6px;margin-bottom:20px;">
			  ...
			  <table class="table table-responsive table-striped table-hover table_cus">
					...
					<tbody>
						...
						<?php 
							$sel="SELECT * FROM final_users NATURAL JOIN final_roles ORDER BY user_id DESC ";
							$sqey=mysqli_query($con,$sel);
							while($data=mysqli_fetch_assoc($sqey)){
						?>
						
						<tr>
							<td><?= htmlspecialchars_decode($data['user_name']);?></td>
